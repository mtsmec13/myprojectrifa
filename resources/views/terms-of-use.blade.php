...
<div class="container" style="margin-bottom: 100px;">
    ...
    <div class="row" style="color: #fff;">
        <div class="col-md-12">
            ...
            Objetivo<br>
            O site {{ env('APP_URL') }}, inscrito sob o CNPJ: 39.790.457/0001-82, visa facilitar a reserva de números nas ações entre amigos de seus clientes, bem como facilitar o gerencimento da mesma através de seus administradores.<br><br>
